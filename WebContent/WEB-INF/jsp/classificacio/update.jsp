...
<head>
    <meta charset="utf-8" />
    <title>Competició Natació - Modificar Classificacio: ${classificacio.nomNadador} # ${classificacio.nomProva}</title>
</head>
<body>
    <h2>Modificar Classificacio: ${classificacio.nomNadador} # ${classificacio.nomProva}</h2>
    <form:form method="post" modelAttribute="classificacio">
        <table>
            ...
            <tr>
                <td colspan="2">
                    <input type="submit" value="Modifica classificacio">
                </td>
            </tr>
        </table>
    </form:form>
